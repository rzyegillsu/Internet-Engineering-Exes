...
## ۱۳. نقشه‌ی راه آینده
- اتصال واقعی به MongoDB و انتقال مدل‌ها از in-memory به دیتابیس
- جایگزینی API Key با لایه‌ی OAuth/JWT Gateway و مدیریت نقش‌ها
- ارسال لاگ‌ها به Elasticsearch یا Grafana Loki و افزودن متریک‌های Prometheus
- Dockerize کردن پروژه و افزودن CI/CD

---

این گزارش تمامی ویژگی‌های فاز دوم و وضعیت کنونی پروژه را پوشش می‌دهد و می‌تواند به‌عنوان مستند تحویل نهایی مورد استفاده قرار گیرد.
